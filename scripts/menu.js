...
menuName[WELL] = "WELL";
menuName[TORCH] = "TORCH";
menuName[GUNPOWDER] = "GUNPOWDER";
menuName[WAX] = "WAX ";
menuName[FALLING_WAX] = "FALLING WAX";
menuName[NITRO] = "NITRO ";
menuName[NAPALM] = "NAPALM";
menuName[C4] = "C-4 ";
menuName[CONCRETE] = "CONCRETE ";
menuName[FUSE] = "FUSE";
menuName[ICE] = "ICE";
menuName[CHILLED_ICE] = "CHILLED ICE";
menuName[LAVA] = "LAVA";
menuName[ROCK] = "ROCK";
menuName[STEAM] = "STEAM";
menuName[CRYO] = "CRYO";
menuName[MYSTERY] = "???";
menuName[METHANE] = "METHANE";
menuName[SOIL] = "SOIL";
menuName[WET_SOIL] = "WET SOIL";
menuName[BRANCH] = "BRANCH";
menuName[LEAF] = "LEAF";
menuName[POLLEN] = "POLLEN";
menuName[CHARGED_NITRO] = "CHARGED NITRO ";
menuName[ACID] = "ACID";
menuName[THERMITE] = "THERMITE";
menuName[BURNING_THERMITE] = "BURNING THERMITE";
menuName[RETRON_MAT] = "RETRON MAT";
